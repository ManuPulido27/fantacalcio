...
void main() async {
  ...
  final outputFile = File('merged_2025_26_with_fbref_corrected.csv');

  print('🔧 Starting CORRECTED FBRef statistics merge...');
  ...
  // Define FBRef column mappings with CORRECT column names
  // Using TOTAL stats (not per-90 stats)
  final fbrefColumnMappings = {
    'MP': 'Partite_Giocate', // Total matches played
    'Starts': 'Partite_Titolare', // Total starts
    'Min': 'Minuti_Giocati', // Total minutes
    '90s': 'Partite_90_Minuti', // Total 90-minute games
    'Gls': 'Gol_Totali', // TOTAL goals (not per-90)
    'Ast': 'Assist_Totali', // TOTAL assists (not per-90)
    'G+A': 'Gol_Plus_Assist', // TOTAL goals+assists
    'G-PK': 'Gol_Senza_Rigori', // TOTAL non-penalty goals
    'PK': 'Rigori_Realizzati', // TOTAL penalties scored
    'PKatt': 'Rigori_Tentati', // TOTAL penalties attempted
    'CrdY': 'Cartellini_Gialli', // TOTAL yellow cards
    'CrdR': 'Cartellini_Rossi', // TOTAL red cards
    'xG': 'Expected_Goals', // TOTAL expected goals
    'npxG': 'Expected_Goals_Senza_Rigori', // TOTAL non-penalty xG
    'xAG': 'Expected_Assist', // TOTAL expected assists
    'npxG+xAG': 'Expected_Goals_Plus_Assist', // TOTAL expected goals+assists
    'PrgC': 'Progressioni_Con_Palla', // TOTAL progressive carries
    'PrgP': 'Progressioni_Passaggi', // TOTAL progressive passes
    'PrgR': 'Progressioni_Ricezioni', // TOTAL progressive receptions
  };
  ...
  print('✅ Corrected merged file created: ${outputFile.path}');
  ...
  if (sampleMatches.isNotEmpty) {
    print('\nSample matches (with CORRECTED data):');
  ...
  print('\n🎉 CORRECTED FBRef statistics merge completed!');
  print('⚠️  IMPORTANT: Now using TOTAL stats (not per-90 stats)');
}
...
Future<void> createUpdatedPositionFiles(
  ...
  print('\n=== CREATING CORRECTED POSITION FILES ===');
  ...
  for (final entry in playersByPosition.entries) {
    ...
    // Create filename
    final fileName = 'giocatori_${ruolo.toLowerCase()}_corrected.csv';
    ...
    // Show top 3 players for this position with CORRECTED FBRef stats
    if (players.isNotEmpty) {
      print('   Top players (CORRECTED data):');
  ...
  print('\n🎉 CORRECTED POSITION FILES CREATED!');
